...
class Walker
  ...
  fun getDistanceMultiplier(): U64 => if heading.isPositive() then 1 else -1 end
...
primitive North fun isPositive(): Bool => true
primitive South fun isPositive(): Bool => false
primitive East  fun isPositive(): Bool => true
primitive West  fun isPositive(): Bool => false
